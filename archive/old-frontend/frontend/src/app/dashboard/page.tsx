...
import { MapPin, Clock, Car, Search, Navigation, Heart, TrendingUp, LogOut } from "lucide-react"
        ...
        <div className="min-h-screen bg-slate-50">
            <div className="container mx-auto px-6 py-8">
                ...
                <div className="mb-8 flex justify-between items-start">
                    ...
                    <button
                        onClick={logout}
                        className="flex items-center space-x-2 text-slate-600 hover:text-slate-900 hover:bg-slate-100 px-4 py-2 rounded-lg transition-colors"
                        title="Logout"
                    >
                        <LogOut size={18} />
